...
using Carsites.IdentityService.Data;
using Carsites.IdentityService.Models;
...
namespace Carsites.IdentityService;
...
internal static class HostingExtensions
{
    ...
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder
            ...
            .AddOpenIdConnect(
                "oidc",
                "Sign-in with demo.duendesoftware.com",
                options =>
                {
        ...
        builder.Services.AddDataProtection().SetApplicationName("IdentityServer");
